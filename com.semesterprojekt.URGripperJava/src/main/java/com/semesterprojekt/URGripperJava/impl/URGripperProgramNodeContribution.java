...
public class URGripperProgramNodeContribution implements ProgramNodeContribution{
	...
	/**
	 * Function to concat command string for TCP socket, returns string
	 * @return A semicolon separated string with the commands generated by the gripper plugin. open/close;toggle force;toggle distance; force value;distance Value
	 */
